...
void lab4() {
    ...
    */
    ...
    cout << Real_sol.x(0, 0) << " " << Real_sol.x(1, 0) << " " << Real_sol.x(2, 0) << " " << Real_sol.y(0, 0) << " "
         << P << " " << Real_sol.g_calls << endl;
...
void lab5() {
    ...
    */
    ...
    for (int i = 0; i < 101; i++) {
        ...
        cout << x0(0) << ";" << x0(1) << ";" << solPow.x(0) << ";" << solPow.x(1) << ";" << solPow.y(0) << ";"
             << solPow.y(1) << ";" << solPow.f_calls << ";";
        solution::clear_calls();
